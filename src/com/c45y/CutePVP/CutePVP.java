...
//				loadPlayers();
			...
			for (String playerName : tm.redTeam.getTeamMembersOnline()) { message += " " + playerName; }
			sender.sendMessage(message);
			message = "Blue Team:";
			for (String playerName : tm.blueTeam.getTeamMembersOnline()) { message += " " + playerName; }
			sender.sendMessage(message);
			message = "Yellow Team:";
			for (String playerName : tm.yellowTeam.getTeamMembersOnline()) { message += " " + playerName; }
			sender.sendMessage(message);
			message = "Green Team:";
			for (String playerName : tm.greenTeam.getTeamMembersOnline()) { message += " " + playerName; }
			sender.sendMessage(message);
			return true;
		} else if (command.getName().equalsIgnoreCase("score")) {
			sender.sendMessage("Score: " + tm.redTeam.encodeTeamColor("Red=" + tm.redTeam.getTeamScore()) + tm.blueTeam.encodeTeamColor(" Blue=" + tm.blueTeam.getTeamScore()) + tm.yellowTeam.encodeTeamColor(" Yellow=" + tm.yellowTeam.getTeamScore()) + tm.greenTeam.encodeTeamColor(" Green=" + tm.greenTeam.getTeamScore()));
			return true;
